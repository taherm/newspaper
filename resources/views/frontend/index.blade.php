...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-sm-8">
            ...
            <!-- /.Politics -->
            <div class="ads">
                <a href="http://{{$ads[2]->url}}"><img src="{{Storage::disk('local')->url($ads[2]->image)}}" class="img-responsive center-block" alt=""></a>
            </div>
        </div>
        <!-- /.left content inner -->
        ...
        <div class="banner-add">
            ...
            <a href="http://{{$ads[1]->url}}"><img src="{{Storage::disk('local')->url($ads[1]->image)}}" class="img-responsive center-block" alt=""></a>
        </div>
        <div class="tab-inner">
            <ul class="tabs">
