                    ...
                    <div class="col-md-4 col-sm-6 padd">
                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                            ...
                            <div class="post-thumb">
                                <a href="<?php echo e(route('posts.show', ['id'=>$post->id])); ?>">
                                    <img class="img-responsive" src="<?php echo e(Storage::disk('local')->url($post->image)); ?>" alt="">
                                </a>
                            </div>
                            <div class="post-info meta-info-rn">
                                <div class="slide">
                                    <a target="_blank" href="#" class="color-1"><?php echo e($post->category->title); ?></a>
                                </div>
                            </div>
                        </div>
                        <div class="post-title-author-details">
                            <h4><a href="<?php echo e(route('posts.show', ['id'=>$post->id])); ?>"><?php echo e($post->title); ?></a></h4>
        ...
        <div class="col-md-4 col-sm-4 left-padding">
            ...
            <form action="<?php echo e(route('search')); ?>" method="GET">
                <div class="input-group search-area">
                    ...
                    <input type="text" class="form-control" placeholder="Search articles here ..." name="posts">
...
<!-- container end -->
<?php echo $__env->make('frontend.partials.mid_slider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!-- second content -->
<section>
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8">
                <!-- article -->
                <div class="add_logo">
                    <a href="http://<?php echo e($ads[4]->url); ?>"><img src="<?php echo e(Storage::disk('local')->url($ads[4]->image)); ?>" class="img-responsive" alt=""></a>
                </div>
