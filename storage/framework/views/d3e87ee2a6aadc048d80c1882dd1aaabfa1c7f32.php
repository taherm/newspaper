            ...
            <div class="row">
                ...
                <div class="col-xs-8 col-md-8 col-sm-8 hidden-xs">
                    <div class="header-banner">
                        <a href="http://<?php echo e($ads[0]->url); ?>"><img class="td-retina img-responsive" src="<?php echo e(Storage::disk('local')->url($ads[0]->image)); ?>" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu menu-slide">
                            ...
                            <li><a href="<?php echo e(route('language.change',['locale' => 'en'])); ?>">English</a></li>
                            <li><a href="<?php echo e(route('language.change',['locale' => 'ar'])); ?>">Arabic</a></li>
                        </ul>
                    </li>
                    <li><a href="<?php echo e(route('contact')); ?>" class="category06">Contact Us</a></li>
...
</header><?php /**PATH C:\xampp\htdocs\newspaper\resources\views/frontend/partials/header.blade.php ENDPATH**/ ?>