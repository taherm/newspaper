        ...
        <nav class="navbar">
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<?php echo e(route('language.change',['locale' => 'en'])); ?>" class="category07">English</a></li>
                    <li><a href="<?php echo e(route('language.change',['locale' => 'ar'])); ?>" class="category07">Arabic</a></li>
