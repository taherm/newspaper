                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center"> <?php echo e($post->title_en); ?> </td>
                                    <td class="center"> <?php echo e($post->description_en); ?> </td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li>
                                                    <form method="POST" action="<?php echo e(route('post.destroy', $post->id)); ?>" class="delete">
