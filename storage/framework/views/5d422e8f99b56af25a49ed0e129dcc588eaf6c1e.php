   ...
   <script src="<?php echo e(asset('/assets/layouts/layout2/scripts/layout.min.js')); ?>" type="text/javascript"></script>
   <script src="<?php echo e(asset('/assets/layouts/layout2/scripts/demo.min.js')); ?>" type="text/javascript"></script>
   <script src="<?php echo e(asset('/assets/layouts/global/scripts/quick-sidebar.min.js')); ?>" type="text/javascript"></script><?php /**PATH C:\xampp\htdocs\newspaper\resources\views/backend/partials/scripts.blade.php ENDPATH**/ ?>